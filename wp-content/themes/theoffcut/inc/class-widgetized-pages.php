...
class Atik_Widgetized_Pages {

	private $transient;

	public function __construct() {
		$this->transient = 'atik_widgetized_pages';
	...
	public function register_widget_areas() {
		...
		foreach ( $pages as $page ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Page: %s', 'atik' ), get_the_title( $page ) ),
				'description'   => sprintf( __( 'Widgets that appear on the "%s" page.', 'atik' ), get_the_title( $page ) ),
...
$GLOBAL['atik_widgetized_pages'] = new Atik_Widgetized_Pages;
