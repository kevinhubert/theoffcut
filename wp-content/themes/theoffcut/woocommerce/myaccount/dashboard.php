...
<header class="myaccount_title">
	<div class="grid">
		<div class="grid__col grid__col--4-of-8">
			<h3><?php esc_html_e( 'My Dashboard', 'atik' ); ?></h3>
		</div>
		<div class="grid__col grid__col--4-of-8">
			<p class="myaccount_dashboard">
				<?php
					echo sprintf( esc_attr__( 'Hello %1$s%2$s%3$s', 'woocommerce' ),
						'<strong>',
				...
				<span>
				<?php
					echo sprintf( esc_attr__( '(not %1$s? %2$sSign out%3$s)', 'woocommerce' ),
						esc_html( $current_user->display_name ),
