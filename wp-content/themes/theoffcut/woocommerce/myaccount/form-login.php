...
<div class="u-columns col2-set login login-navigation wc-tabs-wrapper" id="customer_login">

	<div class="u-column1 col-1">

<?php endif; ?>

		<div class="accordion-tab"><a href="#register"><?php esc_html_e( 'Log In', 'atik' ); ?><i class="genericon"></i></a></div>

		<div id="register" class="registerform wc-tab">

			<h2><?php esc_html_e( 'Log in to your account', 'atik' ); ?></h2>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<div class="accordion-tab"><a href="#log_in"><?php esc_html_e( 'Create New Account', 'atik' ); ?><i class="genericon"></i></a></div>

		<div id="log_in" class="loginform wc-tab">

			<h2><?php esc_html_e( 'Create a new account', 'atik' ); ?></h2>
